/**********************************************************************************
*\file         Credits_Button_MainMenu.h
*\brief        Credits_Button_MainMenu.h
*
...
struct credits_button_mainmenu_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Credits Button MainMenu Script"
    };

    // You have to define this constructor - For internal registration
    credits_button_mainmenu_script(paperback::coordinator::instance& Instance) noexcept :
