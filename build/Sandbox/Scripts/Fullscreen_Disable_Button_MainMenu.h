/**********************************************************************************
*\file         FullScreen_Disable_Button_MainMenu.h
*\brief        FullScreen_Disable_Button_MainMenu.h
*
...
struct fullscreen_disable_button_mainmenu_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Fullscreen Disable Button MainMenu Script"
    };

    // You have to define this constructor - For internal registration
    fullscreen_disable_button_mainmenu_script(paperback::coordinator::instance& Instance) noexcept :
