/**********************************************************************************
*\file         Page6How2Play_Next_Button_MainMenu.h
*\brief        Page6How2Play_Next_Button_MainMenu.h
*
...
struct page6_how2play_next_button_mainmenu_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Page 6 How To Play Next Button MainMenu Script"
    };

    // You have to define this constructor - For internal registration
    page6_how2play_next_button_mainmenu_script(paperback::coordinator::instance& Instance) noexcept :
    ...
    void OnClick() noexcept override
    {
        ...
        PPB.GetSystem<ui_system>().ToggleLayerObjects(static_cast<int>(UI_LAYER::HOWTOPLAY7), true);
    }
};