/**********************************************************************************
*\file         Page2How2Play_Prev_Button_MainMenu.h
*\brief        Page2How2Play_Prev_Button_MainMenu.h
*
...
struct page2_how2play_prev_button_mainmenu_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Page 2 How To Play Prev Button MainMenu Script"
    };

    // You have to define this constructor - For internal registration
    page2_how2play_prev_button_mainmenu_script(paperback::coordinator::instance& Instance) noexcept :
