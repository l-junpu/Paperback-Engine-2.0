/**********************************************************************************
*\file         Page7How2Play_Prev_Button_MainMenu.h
*\brief        Page7How2Play_Prev_Button_MainMenu.h
*
...
struct page7_how2play_prev_button_mainmenu_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Page 7 How To Play Prev Button MainMenu Script"
    };

    // You have to define this constructor - For internal registration
    page7_how2play_prev_button_mainmenu_script(paperback::coordinator::instance& Instance) noexcept :
    ...
    void OnClick() noexcept override
    {
        ...
        PPB.GetSystem<ui_system>().ToggleLayerObjects(static_cast<int>(UI_LAYER::HOWTOPLAY6), true);
    }
};