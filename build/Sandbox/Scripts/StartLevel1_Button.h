/**********************************************************************************
*\file         StartLevel1_Button.h
*\brief        StartLevel1_Button.h
*
...
struct startlevel1_button_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Start Level 1 Button Script"
    };

    // You have to define this constructor - For internal registration
    startlevel1_button_script(paperback::coordinator::instance& Instance) noexcept :
