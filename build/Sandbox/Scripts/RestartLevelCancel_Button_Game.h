/**********************************************************************************
*\file         RestartLevelCancel_Button_Game.h
*\brief        RestartLevelCancel_Button_Game.h
*
...
struct restartlevel_cancel_button_game_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Restart Level Cancel Button Game Script"
    };

    // You have to define this constructor - For internal registration
    restartlevel_cancel_button_game_script(paperback::coordinator::instance& Instance) noexcept :
