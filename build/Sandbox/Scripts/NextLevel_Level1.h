/**********************************************************************************
*\file         NextLevel_Level1.h
*\brief        NextLevel_Level1.h
*
...
struct nextlevel_level1_button_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Next Level Level 1 Button Script"
    };

    // You have to define this constructor - For internal registration
    nextlevel_level1_button_script(paperback::coordinator::instance& Instance) noexcept :
