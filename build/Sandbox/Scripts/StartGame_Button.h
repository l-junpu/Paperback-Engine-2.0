/**********************************************************************************
*\file         StartGame_Button.h
*\brief        StartGame_Button.h
*
...
struct startgame_button_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Start Game Button Script"
    };

    // You have to define this constructor - For internal registration
    startgame_button_script(paperback::coordinator::instance& Instance) noexcept :
