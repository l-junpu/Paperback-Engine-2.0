/**********************************************************************************
*\file         StartLevel3_Button.h
*\brief        StartLevel3_Button.h
*
...
struct startlevel3_button_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Start Level 3 Button Script"
    };

    // You have to define this constructor - For internal registration
    startlevel3_button_script(paperback::coordinator::instance& Instance) noexcept :
