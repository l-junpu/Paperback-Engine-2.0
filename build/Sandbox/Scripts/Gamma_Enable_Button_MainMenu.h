/**********************************************************************************
*\file         Gamma_Enable_Button_MainMenu.h
*\brief        Gamma_Enable_Button_MainMenu.h
*
...
struct gamma_disable_button_mainmenu_script : paperback::script::button_interface // Inherited Type (1)
{
    static constexpr auto typedef_v = paperback::script::type::button
    {
        .m_pName = "Gamma Disable Button MainMenu Script"
    };

    // You have to define this constructor - For internal registration
    gamma_disable_button_mainmenu_script(paperback::coordinator::instance& Instance) noexcept :
    ...
    void OnClick() noexcept override
    {
        ...
        PPB.GetSystem<render_system>().SetGamma(false);
